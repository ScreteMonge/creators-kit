    ...
    public BlenderModel bmVertexColours(Renderable renderable)
    {
        ...
        for (int i = 0; i < model.getFaceCount(); i++)
        {
            ...
            if (shadeFlat)
            {
                ...
                vertexColours[i * 3][0] = vertexColours[i * 3 + 1][0] = vertexColours[i * 3 + 2][0] = h0;
                vertexColours[i * 3][1] = vertexColours[i * 3 + 1][1] = vertexColours[i * 3 + 2][1] = l0;
                vertexColours[i * 3][2] = vertexColours[i * 3 + 1][2] = vertexColours[i * 3 + 2][2] = s0;
                vertexColours[i * 3][3] = vertexColours[i * 3 + 1][3] = vertexColours[i * 3 + 2][3] = tp;
            }
            else
            {
                int fc1i = fc1[i];
